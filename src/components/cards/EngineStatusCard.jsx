...
/**
 * Standalone Reusable Dual Engine Protection Status Card (Flat Minimal Design)
 */
export default function EngineStatusCard({ compact = false }) {
  ...
  if (compact) {
    return (
      <GlassContainer className="p-3 space-y-2 font-sans">
        ...
        <div className="grid grid-cols-2 gap-2 text-[11px]">
          <div className="p-2 rounded-lg bg-[#0F1117] border border-slate-800 space-y-0.5">
  ...
  return (
    <GlassContainer className="p-5 space-y-4 font-sans">
      <div className="flex items-center justify-between border-b border-slate-800 pb-3">
        <div className="flex items-center gap-2.5">
          <div className="p-2 rounded-lg bg-[#E2454A]/10 text-[#E2454A] border border-[#E2454A]/20">
            <ShieldCheck className="w-5 h-5" />
          </div>
          <div>
            <h3 className="text-base font-bold text-white">Dual Protection Engines Status</h3>
            <p className="text-xs text-slate-400">Live operational status of client-side heuristics & VirusTotal cloud intelligence</p>
          </div>
        </div>

        <div className="flex items-center gap-1.5 px-3 py-1 rounded-md bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-bold">
          <CheckCircle2 className="w-3.5 h-3.5" />
          <span>Engines Synchronized</span>
        </div>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {/* Local Heuristic Engine Status */}
        <div className="p-4 rounded-xl bg-[#0F1117] border border-slate-800 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-bold text-white flex items-center gap-2">
              <Cpu className="w-4 h-4 text-cyan-400" />
              1. Local Risk Engine
            </span>
            <span className="text-[10px] font-extrabold text-emerald-400 px-2 py-0.5 rounded-md bg-emerald-500/10 border border-emerald-500/20">
              ACTIVE
            </span>
          </div>
        ...
        <div className="p-4 rounded-xl bg-[#0F1117] border border-slate-800 space-y-2">
          <div className="flex items-center justify-between">
            ...
            {isVtActive ? (
              ...
              <span className="text-[10px] font-extrabold text-amber-400 px-2 py-0.5 rounded-md bg-amber-500/10 border border-amber-500/20">
                DISCONNECTED
              </span>
            )}
          </div>
